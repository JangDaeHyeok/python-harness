...
- [CLI 옵션 레퍼런스](#cli-옵션-레퍼런스)
  ...
  - [auto_pr_pipeline.py](#auto_pr_pipelinepy)
...
| 자동 머지까지 | `python scripts/auto_pr_pipeline.py --base main --auto-merge` | 리뷰 반영 후 PR merge |
| 중단 후 재개 | `python scripts/run_harness.py --resume` | 현재 디렉터리의 latest 체크포인트 재개 |
